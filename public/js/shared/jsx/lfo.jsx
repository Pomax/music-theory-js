    ...
    render() {
        ...
        return (
            <div class={'LFO' + bypass}>
                ...
                <Knob disabled={bypass} cc={0} max={10} value={3.0} label="lfo freq" onInput={v => this.setFrequency(v)}/>
                <Knob disabled={bypass} cc={0} max={10} value={3.0} label="lfo mix" onInput={v => this.setStrength(v)}/>
            </div>
        );
    }
